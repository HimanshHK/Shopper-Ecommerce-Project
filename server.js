...
app.get('/dashboardtrader',(req,res)=>{
    ...
    tradeCartSchem.find({trade:req.session.data.name},(err,result)=>{
        res.render('dashboardtrader',{name:req.session.data.name,email:req.session.data.email,mobile:req.session.data.mobile,items:result});
...
app.get('/dashboard',(req,res)=>{
    ...
    tradeCartSchem.find({price:req.session.data.name},(err,result)=>{
        console.log(result);
        res.render('dashboard',{name:req.session.data.name,email:req.session.data.email,mobile:req.session.data.mobile,items:result});
...
//cart menu
// const tradeCartSchema = {
//     cart: {
//         required: [true, "Please enter your name"],
//         type: String,
//     },
//     price: {
//         required: [true, "Please enter price of item you want"],
//         type: String,
//     },
//     tradername: String
// }

// const Cart = mongoose.model("tradeCart",tradeCartSchema)
const tradeCartSchem = mongoose.model('tradecart',{
    name: { type: String },
    price: { type: String },
    trade: {type: String}
});
...
app.get('/cart',(req,res)=>{
    tradeCartSchem.find({tradername:req.session.data.name}, (err,founditems)=> {
...
app.post('/cart',(req,res)=> {
    ...
    var new_user = new tradeCartSchem({
        name: x,
        price:req.body.price,
        trade: nam
    })
...
app.get('/success.html',function(req,res){
    res.send("<h2 >Payment succesfully recieved...</h2>");
})
...
app.get('/Wishdashboard',function(req,res){
    Item.find({tradername:req.session.data.name}, (err,founditems)=> {
        res.render('Wishdashboard',{name:req.session.data.name,email:req.session.data.email,mobile:req.session.data.mobile,items: founditems});
        })
})

app.post('/Wishdashboard',(req,res)=> {
    const x = req.body.items
    const nam=req.session.data.name;
    const item = new Item({
        item: x,
